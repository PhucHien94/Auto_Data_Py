...
See [`AI_CONTEXT.md`](AI_CONTEXT.md) for the full architecture/decisions context (written for another AI to onboard quickly) and [`SKILL.md`](SKILL.md) for the testcase-vs-BRD review workflow.
...
└── SmartSearch/
    ...
    └── SKILL.md                    "review testcase" skill (BRD↔testcase coverage)
```
